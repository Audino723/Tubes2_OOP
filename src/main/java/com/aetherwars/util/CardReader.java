...
public class CardReader {
    ...
    public static CardRepo read() throws IOException, URISyntaxException {
        ...
        for (String[] row : cardRows2) {
            MorphSpellCard m = new MorphSpellCard.MorphBuilder()
                    ...
                    .setCharToChange((CharacterCard)repo.GetCard(row[4]))
                    .getResult();
            repo.InsertCard(row[0], m);
        }
        ...
        for (String[] row : characterRows5) {
            LevelSpellCard l = new LevelSpellCard.LevelSpellBuilder()
                    .setCardName(row[1])
                    .setCardDescription(row[2])
                    .setCardImagePath(row[3])
        ...
        for (String[] row : characterRows6) {
            ImmuneSpellCard i = new ImmuneSpellCard.ImmuneBuilder()
                    .setCardName(row[1])
                    .setCardDescription(row[2])
                    .setCardImagePath(row[3])
